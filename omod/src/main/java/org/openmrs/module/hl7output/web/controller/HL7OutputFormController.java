...
/**
 * This class configured as controller using annotation and mapped with the URL of 'module/hl7output/basicmoduleLink.form'.
 */
@Controller
...
public class HL7OutputFormController{
	...
	private final String SUCCESS_FORM_VIEW = "/module/hl7output/basicmoduleForm";
