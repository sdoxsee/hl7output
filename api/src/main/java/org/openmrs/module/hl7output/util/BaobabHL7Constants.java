...
public class BaobabHL7Constants {
	
	// MSH
	
	public static final String FIELD_SEPARATOR = "|";
	public static final String ENCODING_CHARACTERS = "^~\\&";
	public static final String MESSAGE_TYPE = "ZPT";
	public static final String TRIGGER_EVENT = "ZP1";
	public static final String MESSAGE_STRUCTURE = "ZPT_ZP1";
	public static final String INTERNATIONALIZATION_CODE = "MWI";
	public static final String VERSION = "2.5";
	public static final String PROCESSING_ID = "D";
	public static final String PROCESSING_MODE = "C";
	public static final String SENDING_FACILITY = "Baobab Health Trust";
